...
import { apiPost, uploadImageS3 } from "../lib/api";
...
export default function CharacterCreatePage() {
  ...
  const handleSubmit = async () => {
    ...
    try {
      const profileImgUrl = await uploadImageS3(uploadFile);
  ...
  return (
    ...
    >
      ...
      >
        ...
        />
        <textarea
          placeholder="습관적인 말과 행동 (예시를 입력해주세요)"
          value={habit}
      ...
      >
        ...
        {extraInfos.map((info, idx) => (
          ...
          >
            ...
            <button
              type="button"
              onClick={() => handleRemoveExtraInfo(idx)}
              style={{
                background: "none",
                border: "none",
                color: "var(--color-point)",
        ...
        <button
          ...
          style={{
            ...
            padding: 12,
            fontWeight: 600,
            color: extraInfos.length >= 10 ? "#ccc" : "var(--color-point)",
            marginBottom: 8,
            cursor: extraInfos.length >= 10 ? "not-allowed" : "pointer",
          }}
        >
      ...
      >
        ...
        <div style={{ marginBottom: 8 }}>
          ...
          >
            이미지를 등록하지 않으면 캐릭터 프로필 사진이 배경으로 활용됩니다.
          </div>
          <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
            {backgroundImg || profileImg ? (
              <div style={{ position: "relative" }}>
                <img
                  src={backgroundImg || profileImg || DEFAULT_PROFILE_IMAGE}
                  alt="배경"
                  style={{
                    width: 120,
                    height: 213,
                ...
                {backgroundImg && (
                  <button
                    type="button"
                    onClick={handleRemoveBackgroundImg}
                    style={{
                      position: "absolute",
                      top: -8,
                      right: -8,
              ...
              <button
                type="button"
                onClick={handleBackgroundImgClick}
                style={{
                  width: 120,
                  height: 213,
                  borderRadius: 12,
                  border: "1.5px dashed var(--color-point)",
                  background: "var(--color-card-alt)",
                  display: "flex",
                  alignItems: "center",
                  justifyContent: "center",
